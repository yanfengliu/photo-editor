...
import { CropRotationPanel } from "./panels/CropRotationPanel";
...
export function DevelopView() {
  ...
  return (
    <div className={styles.develop}>
      ...
      {rightPanelOpen && <div className={styles.rightPanel}><div className={styles.panels}><CropRotationPanel /><WhiteBalance /><BasicAdjustments /><ToneCurve /><HSLPanel /><DetailPanel /><LensCorrectionPanel /><EffectsPanel /></div></div>}
    </div>
  );
}
